...
document.addEventListener('init', function(event) {
  ...
  if (page.id === 'menuP')
  {
    ...
    document.getElementById("qtitle").innerHTML = GameData[0].questions[0].id+". "+GameData[0].questions[0].text;
    document.getElementById("Q1-0").type = GameData[0].questions[0].type;
